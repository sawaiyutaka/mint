...
output_file = r"D:/mint/results/linear_regression_unadj_AF3_4grp.xlsx"
...
# =========================
# 6-1. reverse score の作成
# =========================
# 解釈しやすくするため、
# ポジティブな要素を 0 からマイナスして使用する。
#
# G3, G3_12m, G3_18m: 経済的ゆとり
# age_corrected: 母親の年齢
#
# 例:
#   元の G3_12m が 5 の場合 → -5
#   元の age_corrected が 30 の場合 → -30
#
...
# ---------------------------------
# 8-3. 曝露因子 → アウトカム
#      AF3_4grp ~ age_corrected
#      AF3_4grp ~ low_income_baseline
#      AF3_4grp ~ mother_education_6grp
# ---------------------------------
